...
type Props = {
    postulation: NonNullable<
        TrackerCurrentStepQuery['trackerCurrentStep']['platziPostulation']
    >;
    newForm: TrackerCurrentStepQuery['trackerCurrentStep']['platziForm'];
};
...
export const TrackerStep4PlatziApplicationReceived: React.FC<Props> = ({
    postulation,
    newForm,
}) => {
