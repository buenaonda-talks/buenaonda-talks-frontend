...
const SideNavigation = ({ className }: SidebarProps) => {
...
export const DashboardErrorScreen = () => {
    return (
        <div className="flex h-screen overflow-hidden">
            <SideNavigation className="w-[270px]" />

            <main className="min-w-0 flex-1">
                <ScrollArea className="h-screen">
                    <div className="flex h-screen items-center justify-center">
                        <div>
                            <h1 className="mb-0.5 text-center text-xl font-semibold">
